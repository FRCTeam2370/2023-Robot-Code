...
addCommands(new CloseGripper(m_Sub_Gripper),new align_to_target(s_Swerve, 2, 0, 0), new high_goal(m_sub_Elbow, m_sub_Shoulder) ,new WaitCommand(1),
...
new ParallelCommandGroup(swerveControllerCommand2, new stow(m_sub_Elbow, m_sub_Shoulder)), new  InstantCommand(() -> s_Swerve.zeroGyro()) ,
