...
public class stow extends SequentialCommandGroup {
  /** Creates a new stow. */
  public stow(sub_Shoulder shoulder, sub_Elbow elbow) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(
      new Move_Elbow(elbow, 60000).alongWith(new Move_Shoulder(shoulder, 4700)).andThen(new Move_Elbow(elbow, 10000))
    );
  }
}
