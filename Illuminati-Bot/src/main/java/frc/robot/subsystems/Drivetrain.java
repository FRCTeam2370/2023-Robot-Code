...
/*to do
 * 1. add auto driving fix while turning
 * 2. add fix to wheels having a seizure and get quickest path
...
public class Drivetrain extends SubsystemBase {
  ...
  public static void swervecontrol(WPI_TalonFX drivemoter, WPI_TalonFX turnmoter, swerveMath whatspot, double x,
      double y, double z) {
    // gets field oration
